...
final class NatsTest extends TestCase
{
    ...
    public function testTransport(): void
    {
        ...
        self::assertStringMatchesFormat(
            <<<'TXT'
                %A
                [%s] test.DEBUG: Message "{message}" sent to transport {"payload":"\"O:8:\\\"stdClass\\\":1:{s:5:\\\"test1\\\";b:1;}\"","duplicate":null,"stream":"testTransport%s","message":"stdClass","message_id":"%s"} []
                %A
                TXT,
    ...
    public function testFallback(): void
    {
        ...
        $factory = new NatsTransportFactory(new MessageMap([]), new NullLogger(), new NullLogger(), self::createStub(NormalizerInterface::class), $fallbackFactory);
